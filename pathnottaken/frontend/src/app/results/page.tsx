              ...
              <div className="lg:hidden card-static p-5 mb-4 space-y-4 animate-fade-in">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="range" min={18000} max={120000} step={5000} value={salaryMin} onChange={(e) => setSalaryMin(Number(e.target.value))} className="w-full accent-emerald-600" />
                    <div className="flex justify-between text-xs text-gray-400 mt-1">
                      <span>₱18K</span>
                ...
                <button onClick={() => { setSalaryMin(18000); setGrowthFilter("Any"); }} className="text-sm text-gray-500 hover:text-gray-700">Reset filters</button>
              </div>
            )}
